...
let transporter = nodemailer.createTransport({
	...
	auth: {
		user: 'vaimbhav05@gmail.com', // gmail
...
// Helper function to deserialize user
...
exports.cookieExtractor = function (req) {
	const token =
		(req.body && req.body.token) || (req.cookies && req.cookies.jwt);
	return token;
};
...
exports.sendMail = async function ({to, subject, text, html}) {
	let info = await transporter.sendMail({
		from: '"E-commerce" <vaimbhav05@gmail.com>', // sender address
		to,
		subject,
		text,
		html,
